...
public class DeleteVEvents extends ProcessVEvent {
	...
	public void run(ProgressDialog dialog) {
		// if (!DialogTools.decisionDialog(getActivity(),
		// R.string.dialog_information_title,
		// R.string.dialog_delete_entries, R.string.dialog_yes,
		// R.string.dialog_no,
		// R.drawable.calendar)) {
		// return;
		// }
		...
		// ContentValues values = VEventWrapper.resolve((VEvent) event,
		// getCalendarId());
		// List<Integer> ids = getIds(values);
		//
		// for (Integer id : ids) {
		// i += contentResolver.delete(
		// Uri.withAppendedPath(VEventWrapper.getContentURI(),
		// Integer.toString(id)),
		// null, null);
		// // Delete reminder
		...
		// getActivity().getString(R.string.dialog_information_title),
		// getActivity()
