 ...
 * <li>The {@link android.provider.CalendarContract.Events} table holds the event specific information. Each row
 ...
 * properties are stored on separate tables and reference the {@link android.provider.CalendarContract.Events#_ID}
 ...
 * <ul>
 * <li>
 * {@link android.provider.CalendarContract.SyncState}, which contains free-form data maintained by the sync
 * adapters</li>
 * </ul>
 *
 */
...
public final class CalendarContract {
     ...
     */
    public static final boolean legacyApi = Build.VERSION.SDK_INT<14;
...
//    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
     ...
     * specified in {@link android.provider.CalendarContract.EventsColumns#CUSTOM_APP_PACKAGE}. The custom app
     * will be started via {@link android.app.Activity#startActivityForResult(android.content.Intent, int)}
     * and it should call {@link android.app.Activity#setResult(int)} with
     * {@link android.app.Activity#RESULT_OK} or {@link android.app.Activity#RESULT_CANCELED} to
     ...
     * </pre>
     * <p>
     * Input: {@link android.content.Intent#getData} has the event URI. The extra
     * {@link #EXTRA_EVENT_BEGIN_TIME} has the start time of the instance. The
     * extra {@link #EXTRA_CUSTOM_APP_URI} will have the
     * {@link android.provider.CalendarContract.EventsColumns#CUSTOM_APP_URI}.
     * <p>
     * Output: {@link android.app.Activity#RESULT_OK} if this was handled; otherwise
...
//    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    ...
    /**
     * Intent Extras key: {@link android.provider.CalendarContract.EventsColumns#CUSTOM_APP_URI} for the event in
    ...
    protected interface SyncColumns extends CalendarSyncColumns {
         ...
         * along with {@link android.provider.BaseColumns#_ID}.
         * <P>Type: TEXT</P>
         */
         ...
         * {@link android.provider.CalendarContract.Events#LAST_SYNCED} set to 1 whenever the event
    ...
    protected interface CalendarColumns {
        ...
        /**
         * A key for looking up a color from the {@link android.provider.CalendarContract.Colors} table. NULL or
         ...
         * {@link android.provider.CalendarContract.Colors} table. @see Colors
         * <P>
         * Type: TEXT
         * </P>
         */
        ...
        */
         ...
         * {@link android.provider.CalendarContract.Reminders#METHOD_DEFAULT}, {@link android.provider.CalendarContract.Reminders#METHOD_ALERT},
         * {@link android.provider.CalendarContract.Reminders#METHOD_EMAIL}, {@link android.provider.CalendarContract.Reminders#METHOD_SMS},
         * {@link android.provider.CalendarContract.Reminders#METHOD_ALARM}. Column name.
         * <P>Type: TEXT</P>
         */
         ...
         * calendar in the format "#,#,#". Valid types are
         * {@link android.provider.CalendarContract.Events#AVAILABILITY_BUSY}, {@link android.provider.CalendarContract.Events#AVAILABILITY_FREE},
         * {@link android.provider.CalendarContract.Events#AVAILABILITY_TENTATIVE}. Setting this field to only
         * {@link android.provider.CalendarContract.Events#AVAILABILITY_BUSY} should be used to indicate that
         ...
         * in the format "#,#,#". Valid types are {@link android.provider.CalendarContract.Attendees#TYPE_NONE},
         * {@link android.provider.CalendarContract.Attendees#TYPE_OPTIONAL}, {@link android.provider.CalendarContract.Attendees#TYPE_REQUIRED},
         * {@link android.provider.CalendarContract.Attendees#TYPE_RESOURCE}. Setting this field to only
         * {@link android.provider.CalendarContract.Attendees#TYPE_NONE} should be used to indicate that changing
...
//        }
     ...
     * parameters. See
     * {@link android.net.Uri.Builder#appendQueryParameter(String, String)}
     ...
     * {@link android.content.ContentUris#withAppendedId}) or as the first selection item--the
    ...
    protected interface AttendeesColumns {
         ...
         * {@link android.provider.ContactsContract.CommonDataKinds.Identity#IDENTITY}.
         ...
         * {@link android.provider.ContactsContract.CommonDataKinds.Identity#NAMESPACE}.
     ...
     * {@link #query(android.content.ContentResolver, long, String[])} will return a list of attendees for
    ...
    protected interface EventsColumns {
        ...
        /**
         * The {@link android.provider.CalendarContract.Calendars#_ID} of the calendar the event belongs to.
         * Column name.
         * <P>Type: INTEGER</P>
         */
         ...
         * {@link android.provider.CalendarContract.Calendars#CALENDAR_COLOR}.
         * Read-only value. To modify, write to {@link #EVENT_COLOR} or
         * {@link android.provider.CalendarContract.Calendars#CALENDAR_COLOR} directly.
         *<P>
         *     Type: INTEGER
         *</P>
         */
         ...
         * event is on a calendar with {@link android.provider.CalendarContract.Calendars#CAN_PARTIALLY_UPDATE} set to 1. This copy
        ...
        /**
         * The {@link android.provider.CalendarContract.Events#_ID} of the original recurring event for which this
         ...
         * {@link android.provider.CalendarContract#ACTION_HANDLE_CUSTOM_EVENT} for details.
         * Column name.
         * <P> Type: TEXT </P>
         */
     ...
     * make batch operations easier. A {@link android.content.ContentResolver} or
     * {@link android.content.ContentProviderClient} is required as the helper does additional
...
//        }
     ...
     * <dt><b>Update</b></dt>
     * <dd>To perform an update of an Event the {@link android.provider.CalendarContract.Events#_ID} of the event
     * should be provided either as an appended id to the Uri (
     * {@link android.content.ContentUris#withAppendedId}) or as the first selection item--the
     * selection should start with "_id=?" and the first selectionArg should be
     ...
     * <dt><b>Delete</b></dt>
     * <dd>Events can be deleted either by the {@link android.provider.CalendarContract.Events#_ID} as an appended
     ...
     * or at most a single row if the {@link android.provider.CalendarContract.Events#_ID} is appended to the Uri.
     ...
     * <ul>
     * <li>If allDay is set to 1 eventTimezone must be {@link android.text.format.Time#TIMEZONE_UTC}
    ...
    public static final class Events implements BaseColumns, SyncColumns, EventsColumns,
         ...
         * event id using {@link android.content.ContentUris#withAppendedId(android.net.Uri, long)} will
         ...
         * the exception event ID (see {@link android.net.Uri.Builder#appendPath}).
         */
    ...
    protected interface CalendarCacheColumns {
        /**
         * The key for the setting. Keys are defined in {@link android.provider.CalendarContract.CalendarCache}.
         */
     ...
     * {@link #query(android.content.ContentResolver, long, String[])} will return a list of reminders for
     * the event with the given eventId. Both apps and sync adapters may write
     ...
     * have been removed from the {@link android.provider.CalendarContract.Calendars} or {@link android.provider.CalendarContract.Events} tables.
     */
