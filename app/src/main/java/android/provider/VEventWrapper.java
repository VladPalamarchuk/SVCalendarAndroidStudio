...
import android.provider.GoogleVEventWrapper.IGoogleWrapper;
import android.provider.GoogleVEventWrapper.IVEventWrapper;
...
public class VEventWrapper {
	...
	private static String[] keys = new String[] { "organizer", "rrule",
